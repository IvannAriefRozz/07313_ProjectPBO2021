...
public class RecordEntity {
   ...
   public int getClusterNumber() {
    ...
    public String toString() {
        return "Record [Provinisi= "+ provinsi + ",TingkatKematian= "+ TingkatKematian + ",JumlahKasus= "+ JumlahKasus + ",PotensiPenularan= "+ PotensiPenularan +",clusterNumber= "+ clusterNumber + "]";
    }    
}
